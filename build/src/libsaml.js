...
var libSaml = function () {
    ...
    */
    ...
    return {
            ...
            return {
                KeyDescriptor: [{
                        ...
                        KeyInfo: [{
                                ...
                                X509Data: [{
                                        X509Certificate: utility_1.default.normalizeCerString(certString),
                                    }],
                            }],
                    }],
            };
        ...
        */
        getKeyInfo: function (x509Certificate) {
                ...
                if (xml) {
                    ...
                    if (sourceEntitySetting_1.isAssertionEncrypted) {
                        xmlenc.encrypt(assertions_1[0].toString(), {
                            ...
                            var encryptAssertionNode = new dom().parseFromString("<" + encAssertionPrefix + ":EncryptedAssertion>" + res + "</" + encAssertionPrefix + ":EncryptedAssertion>");

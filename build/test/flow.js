...
ava_1.default('create login response with undefined binding', function (t) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, t.throws(idp.createLoginResponse(sp, {}, 'undefined', { email: 'user@esaml2.com' }))];
            case 1:
                error = _a.sent();
...
ava_1.default('create post login response', function (t) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, idp.createLoginResponse(sp, null, 'post', { email: 'user@esaml2.com' })];
            case 1:
...
ava_1.default('create logout response with undefined binding', function (t) {
    try {
        var _a = idp.createLogoutResponse(sp, {}, 'undefined'), id = _a.id, context = _a.context;
        t.fail();
    }
    catch (e) {
...
ava_1.default('create logout response with redirect binding', function (t) {
    var _a = idp.createLogoutResponse(sp, {}, 'redirect'), id = _a.id, context = _a.context;
    _.isString(id) && _.isString(context) ? t.pass() : t.fail();
});
ava_1.default('create logout response with post binding', function (t) {
    var _a = idp.createLogoutResponse(sp, {}, 'post'), relayState = _a.relayState, type = _a.type, entityEndpoint = _a.entityEndpoint, id = _a.id, context = _a.context;
...
ava_1.default('send response with signed assertion and parse it', function (t) { return __awaiter(_this, void 0, void 0, function () {
    var _a, id, SAMLResponse, _b, samlContent, extract;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, idpNoEncrypt.createLoginResponse(sp, { extract: { authnrequest: { id: 'request_id' } } }, 'post', { email: 'user@esaml2.com' })];
            case 1:
...
ava_1.default('send response with signed message and parse it', function (t) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, idpNoEncrypt.createLoginResponse(spNoAssertSign, { extract: { authnrequest: { id: 'request_id' } } }, 'post', { email: 'user@esaml2.com' })];
            case 1:
                _a = _c.sent(), id = _a.id, SAMLResponse = _a.context;
...
ava_1.default('send login response with signed assertion + signed message and parse it', function (t) { return __awaiter(_this, void 0, void 0, function () {
    var spWantMessageSign, _a, id, SAMLResponse, _b, samlContent, extract;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                spWantMessageSign = serviceProvider(__assign({}, defaultSpConfig, { wantMessageSigned: true }));
                return [4 /*yield*/, idpNoEncrypt.createLoginResponse(spWantMessageSign, { extract: { authnrequest: { id: 'request_id' } } }, 'post', { email: 'user@esaml2.com' })];
            case 1:
                _a = _c.sent(), id = _a.id, SAMLResponse = _a.context;
...
ava_1.default('send login response with encrypted non-signed assertion and parse it', function (t) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, idp.createLoginResponse(spNoAssertSign, { extract: { authnrequest: { id: 'request_id' } } }, 'post', { email: 'user@esaml2.com' })];
            case 1:
                _a = _c.sent(), id = _a.id, SAMLResponse = _a.context;
...
ava_1.default('send login response with encrypted signed assertion and parse it', function (t) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, idp.createLoginResponse(sp, { extract: { authnrequest: { id: 'request_id' } } }, 'post', { email: 'user@esaml2.com' })];
            case 1:
                _a = _c.sent(), id = _a.id, SAMLResponse = _a.context;
...
ava_1.default('send login response with encrypted signed assertion + signed message and parse it', function (t) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                spWantMessageSign = serviceProvider(__assign({}, defaultSpConfig, { wantMessageSigned: true }));
                return [4 /*yield*/, idp.createLoginResponse(spWantMessageSign, { extract: { authnrequest: { id: 'request_id' } } }, 'post', { email: 'user@esaml2.com' })];
            case 1:
                _a = _c.sent(), id = _a.id, SAMLResponse = _a.context;
...
ava_1.default('sp sends a post logout response without signature and parse', function (t) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _a = sp.createLogoutResponse(idp, null, 'post'), relayState = _a.relayState, type = _a.type, entityEndpoint = _a.entityEndpoint, id = _a.id, SAMLResponse = _a.context;
...
ava_1.default('sp sends a post logout response with signature and parse', function (t) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _a = sp.createLogoutResponse(idpWantLogoutResSign, null, 'post'), relayState = _a.relayState, type = _a.type, entityEndpoint = _a.entityEndpoint, id = _a.id, SAMLResponse = _a.context;
...
ava_1.default('send login response with encrypted non-signed assertion with EncryptThenSign and parse it', function (t) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, idpEncryptThenSign.createLoginResponse(spNoAssertSignCustomConfig, { extract: { authnrequest: { id: 'request_id' } } }, 'post', { email: 'user@esaml2.com' }, undefined, true)];
            case 1:
                _a = _c.sent(), id = _a.id, SAMLResponse = _a.context;
...
ava_1.default('Customize prefix (saml2) for encrypted assertion tag', function (t) { return __awaiter(_this, void 0, void 0, function () {
    var idpCustomizePfx, _a, id, SAMLResponse, _b, samlContent, extract;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                return [4 /*yield*/, idpCustomizePfx.createLoginResponse(sp, null, 'post', { email: 'test@email.com' })];
            case 1:
                _a = _c.sent(), id = _a.id, SAMLResponse = _a.context;
...
ava_1.default('Customize prefix (default is saml) for encrypted assertion tag', function (t) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, idp.createLoginResponse(sp, null, 'post', { email: 'test@email.com' })];
            case 1:
                _a = _c.sent(), id = _a.id, SAMLResponse = _a.context;
